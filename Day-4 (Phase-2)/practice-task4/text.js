...
function elementsFactory(elements){
    ...
    div2Btn1.classList.add('edit-btn', 'text-[#8B93A7]', 'hover:text-[#4C8DFF]', 'text-xs', 'font-medium', 'border', 'border-[#262B36]', 'rounded-lg', 'px-3', 'py-1.5', 'transition');
    div2Btn2.classList.add('delete-btn', 'text-[#8B93A7]', 'hover:text-rose-400', 'text-sm', 'leading-none', 'transition');
    ...
    div2Btn1.textContent = 'Edit';
    div2Btn2.textContent= '✕';
    ...
    div2.appendChild(div2Btn1)
    div2.appendChild(div2Btn2)
    primaryDiv.appendChild(viewModenote)
    // customersContainer.appendChild()
    // customersContainer.appendChild()
    // customersContainer.appendChild()

    editModeBtn1.addEventListener((click), () => {
        div2.appendChild(editModenote);
    })
