...
addBtn.addEventListener('click', () => {
   ...
   // li elemenets
   listItems.innerHTML = `<span class="w-[350px] break-all">${noteBox.value}</span>
    <!-- icon -->
        <svg id="deleteBtn" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 cursor-pointer hidden group-hover:block">
